...
function createAPI(config) {
  ...
  var handler = handlers => /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(function* (req, res) {
      ...
      if (res.headersSent) {
        console.warn('[nextkit] Nextkit has possibly detected a bug — headers have been sent but a NO_RESPONSE_SENTINEL was not found as an internal result type. Exiting early to prevent a double-send.');
        return;
      }
...
exports.NextkitError = NextkitError;
