...
export declare type Environment = Record<string, string | undefined>;
export declare type Errors = Record<string, Error>;
export declare type ReporterOpts<TCleanEnv> = {
    env: Environment;
...
export declare type Validators<TCleanEnv> = {
